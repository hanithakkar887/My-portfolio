...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.addEventListener('visibilitychange', function () {
        document.title = document.visibilityState === "visible" ? "Portfolio | Hani Thakkar" : "Come Back To Portfolio";
        document.getElementById("favicon").setAttribute("href", document.visibilityState === "visible" ? "assets/images/profile-pic.png" : "assets/images/favhand.png");
    });
    ...
    [
        '.home .content h3', '.home .content p', '.home .content .btn', '.home .image', '.home .linkedin',
        '.home .github', '.home .twitter', '.home .telegram', '.home .instagram', '.home .dev',
        '.about .content h3', '.about .content .tag', '.about .content p', '.about .content .box-container',
        '.about .content .resumebtn', '.skills .container', '.skills .container .bar', '.education .box',
        '.experience .timeline', '.experience .timeline .container', '.contact .container',
        '.contact .container .form-group'
    ].forEach(selector => srtop.reveal(selector, { delay: 200 }));
});
